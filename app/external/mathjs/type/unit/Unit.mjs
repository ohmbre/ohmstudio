import { isComplex, isUnit, typeOf } from '../../utils/is.mjs'
import { factory } from '../../utils/factory.mjs'
import { endsWith } from '../../utils/string.mjs'
import { clone, hasOwnProperty } from '../../utils/object.mjs'
import { createBigNumberPi as createPi } from '../../utils/bignumber/constants.mjs'
...
export const createUnitClass = /* #__PURE__ */ factory(name, dependencies, ({
   ...
   * BigNumber, or Fraction depending on the math.mjs config setting `number`.
   *
