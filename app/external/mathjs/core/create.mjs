...
import { deepFlatten, isLegacyFactory, lazy, traverse, values } from './../utils/object.mjs'
import * as emitter from './../utils/emitter.mjs'
import { importFactory } from './function/import.mjs'
import { configFactory } from './function/config.mjs'
import { factory, isFactory } from '../utils/factory.mjs'
import {
  isAccessorNode,
  isArray,
  isArrayNode,
...
import { initial, last } from '../utils/array.mjs'
 ...
 * @returns {Object} Returns a bare-bone math.mjs instance containing
 *                   functions:
