import { isBigNumber, isComplex, isFraction, isMatrix, isUnit } from '../../utils/is.mjs'
import { isFactory, stripOptionalNotation } from '../../utils/factory.mjs'
import { hasOwnProperty, isLegacyFactory, lazy, traverse } from '../../utils/object.mjs'
import { contains } from '../../utils/array.mjs'
...
export function importFactory (typed, load, math, importedFactories) {
   ...
   *     The wrapper is needed when extending math.mjs with libraries which do not
   *     support these data type. False by default.
   *
   * Examples:
   *
   *    import { create, all } from 'mat.mjs'
  ...
  /**
   * Import an instance of a factory into math.mjs
