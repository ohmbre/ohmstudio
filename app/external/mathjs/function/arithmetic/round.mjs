...
import { isInteger } from '../../utils/number.mjs'
...
import { roundNumber } from '../../plain/number.mjs'
...
export const createRound = /* #__PURE__ */ factory(name, dependencies, ({ typed, matrix, equalScalar, zeros, BigNumber, DenseMatrix }) => {
  ...
  const roundSigs = {}
  Object.assign(roundSigs, roundNumberSignatures)    
  Object.assign(roundSigs, {
