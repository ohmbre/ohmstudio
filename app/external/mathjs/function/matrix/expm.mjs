import { isSparseMatrix } from '../../utils/is.mjs'
...
export const createExpm = /* #__PURE__ */ factory(name, dependencies, ({ typed, abs, add, identity, inv, multiply }) => {
  ...
  function findParams (infNorm, eps) {
    ...
    throw new Error('Could not find acceptable parameters to compute the matrix exponential (try increasing maxSearchSize in expm.mjs)')
  }
