import { isAccessorNode, isFunctionAssignmentNode, isIndexNode, isNode, isSymbolNode } from '../../utils/is.mjs'

import { escape } from '../../utils/string.mjs'
import { hasOwnProperty } from '../../utils/object.mjs'
import { map } from '../../utils/array.mjs'
import { getSafeProperty, validateSafeMethod } from '../../utils/customs.mjs'
import { factory } from '../../utils/factory.mjs'
import { defaultTemplate, latexFunctions } from '../../utils/latex.mjs'
...
export const createFunctionNode = /* #__PURE__ */ factory(name, dependencies, ({ math, Node, SymbolNode }) => {
   ...
   * @param {Object} math     Math.mjs namespace with functions and constants.
