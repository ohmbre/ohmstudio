import { isChain } from '../../utils/is.mjs'
import { format } from '../../utils/string.mjs'
import { hasOwnProperty, lazy } from '../../utils/object.mjs'
...
export const createChainClass = /* #__PURE__ */ factory(name, dependencies, ({ on, math }) => {
   ...
   * the value.
   *
   * All methods available in the math.mjs library can be called upon the chain,
  ...
  // create proxy for everything that is in math.mjs
